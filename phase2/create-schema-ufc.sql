CREATE TABLE compare (
  PRIMARY KEY(id) varchar(10) DEFAULT NULL,
  FOREIGN KEY (user_id) REFERENCES users(user_id),
  FOREIGN KEY (fighter_id1) references fighter(fighter_id),
  FOREIGN KEY (fighter_id2) references fighter(fighter_id),
  winner varchar(10) DEFAULT NULL
);

CREATE TABLE fighter (
  PRIMARY KEY (fighter_id) int(4) DEFAULT NULL,
...
CREATE TABLE fights (
  PRIMARY KEY (fight_id) int(3) DEFAULT NULL,
